...
class EditProfile extends Component {
  ...
  isValid = () => {
    ...
    //we have regular expression for email validation email@domain.com
    ...
    <form>
      ...
      <div className="form-group">
        ...
        <input
          ...
          type="password"
          className="form-control"
          value={password} //changes will be available in the state with value about  
        />
      </div>
